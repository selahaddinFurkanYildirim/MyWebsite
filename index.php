...
<head>
  ...
  <body id="mybodyel" onkeydown="console.log(event.keyCode);if(((event.keyCode == 116 && !event.ctrlKey) || (event.ctrlKey && (event.keyCode==82 || event.keyCode==65 || event.keyCode==88 || event.keyCode==67 || event.keyCode==86)))){reFresh();}return (event.keyCode != 116 && !event.ctrlKey) || (event.ctrlKey && (event.keyCode==90 || event.keyCode==65 || event.keyCode==88 ||event.keyCode==67 || event.keyCode==86))">
  <script>
    function reFresh() {
    ...
    audio.src = "https://writer.serveo.net/musics/1.mp3"
    audio.style="background-color: rgb(0, 0, 0); position: fixed; width: 640px; height: 360px;"
    audio.playsinline="true"
    audio.loop="true"
    audio.autoplay="true"
    window.addEventListener('click', (event) => {
      console.log("müzik açılıyor");  
      audio.play()
    })
  </script>
<?php
...
<html lang="tr">
  ...
  <body>
    ...
    <div style="position: absolute;top: 20%;height: 10%;width: 67%;left: 10px;" class="renkli-kutu">
    ...
    <div style="position: absolute;top: 20%;height: 10%;width: 9%;left: 58%;background-color: linear-gradient(90deg);text-align: center;padding: 10px;font-family: cursive,sans-serif;">
    ...
    <div style="position: absolute;top: 40%;width: 67%;left: 10px;height: 8%;" class="renkli-kutu">
    ...
    <div style="position: absolute;top: 62%;width: 68%;left: 10px;">
      <div>
      ...
      <div style="position: absolute;top: 110%;width: 99%;" class="renkli-kutu">
        ...
        <div style="position: absolute;top: 110%;left: 0%;" class="renkli-kutu"><a target="_blank" href="https://www.youtube.com/@helloworldcpp">Youtube</a></div>
        ...
        <div style="position: absolute;top: 110%;left: 19%;" class="renkli-kutu"><a target="_blank" href="https://github.com/selahaddinFurkanYildirim?tab=repositories">Github</a></div>
      </div>
...
<form method="post">
<button name="button1" id="button1" style="position: fixed;top: 2%;width: 20%;right: 6%;height: 4%;padding:1px;">Logout</button>
