...
<head>
  ...
  <meta
      name="description"
      content=" Writer projesi herkes için kolayca internetten kolayca erişim sağlanabilecek bir projedir.
      Projenin amacı herkese iletişim halinde kalma ve kod yazma için alternatifler sunmaktır.
      Kod yazanlar için (linuxbash)(C++)(python) dillerinde kod yazmayı destekler.
      Evrensel mesajlaşma otomatik olarak güncellenir ve güvenlik sebebiyle sayfa yenilendiğinde sıfırlanır.
      Writer porjesinin adı kod ve mesajlaşma için yazmanın gerekli olmasından ve bunun ingilizce anlamının write olmasından dolayıdır.">
    <link href="img/favicon.png" rel="shortcut icon" type="image/x-icon">
    <link href="img/logo.png" rel="apple-touch-icon">
    <meta name="description" content="Bu site Kod yazmanızı sağlayan online debugger işlevi gören bir sitedir.">
