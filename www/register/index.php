...
<div style="position: fixed;top: 35%;width: 40%;left: 30%;height: 25%;" class="renkli-kutu">
    ...
    <a style="font-size: 20px;">Register to Writer</a>
    <hr>
    ...
    <input style="width: 80%;" autocomplete="off" type="text" id="mails" name="mails" placeholder="yourMail or phone number (just for communication)">
    <br>
    <input style="position: absolute;width: 20%;left: 40%;" id="command" name="command" type="submit" value="Register">
    </form>
</div>
